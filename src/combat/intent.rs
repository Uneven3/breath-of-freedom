...
//!
//! `wants_guard`/`wants_parry`/`wants_aim` land with their phases
//! (`combat-defense`, `combat-bow`) — fields are added when a motor reads
//! them, never before (dead data is a lie waiting to happen).
